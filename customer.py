...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        """
        # recording all calls
        for call_record in self._phone_lines:
            if call.src_number == call_record.get_number():
                call_record.make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        """
        # receiving all calls
        for call_receive in self._phone_lines:
            if call.dst_number == call_receive.get_number():
                call_receive.receive_call(call)
